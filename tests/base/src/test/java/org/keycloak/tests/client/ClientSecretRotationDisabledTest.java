...
@KeycloakIntegrationTest(config = ClientSecretRotationDisabledTest.DisabledClientSecretRotationServerConfig.class)
public class ClientSecretRotationDisabledTest {
    ...
    static class DisabledClientSecretRotationServerConfig implements KeycloakServerConfig {
