...
final class VciTestSigningKey {
    ...
    static {
        try {
            ...
            Path keyStorePath = Files.createTempFile(ConformanceSigningKey.getRealmKeystoreFolder(
                    VciConformanceRealmConfig.REALM), "keycloak-oid4vci-conformance-signing", ".p12");
