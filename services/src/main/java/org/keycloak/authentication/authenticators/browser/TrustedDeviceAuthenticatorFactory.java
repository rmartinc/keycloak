...
public class TrustedDeviceAuthenticatorFactory implements AuthenticatorFactory {
    ...
    public static final String TRUST_DEVICE_AUTH_NOTE = "trust-device";
    public static final String TRUST_DEVICE_SHOW = "show";
    public static final String TRUST_DEVICE_CREATED = "created";
    public static final String REALM_TRUST_DEVICES_EXPIRATION_ATTR = "trustedDeviceExpiration";
