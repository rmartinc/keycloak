...
public class ParameterizedScopeMapper extends AbstractOIDCProtocolMapper
    ...
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession,
        ...
        Optional<ClientScopeModel> clientScopeOptional = resolveClientScope(mappingModel, clientSessionCtx);
        if (clientScopeOptional.isEmpty()) {
            return;
        }

        ClientScopeModel clientScope = clientScopeOptional.get();
