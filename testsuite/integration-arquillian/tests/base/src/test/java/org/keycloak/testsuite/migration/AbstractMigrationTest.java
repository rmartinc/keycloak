...
public abstract class AbstractMigrationTest extends AbstractKeycloakTest {
    ...
    private void testClientAttributes(RealmResource realm) {
        ...
        Assert.assertTrue(client.getAttributes().get("saml_idp_initiated_sso_url_name").length() > 255);
        Assert.assertNotNull(client.getAttributes().get("extremely_long_attribute"));
        Assert.assertTrue(client.getAttributes().get("extremely_long_attribute").length() > 255);
        Assert.assertNotNull(client.getAttributes().get("weird_attribute"));
        Assert.assertTrue(client.getAttributes().get("weird_attribute").length() == 255);
