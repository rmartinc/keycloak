...
public class SimpleHttp {
    ...
    public static SimpleHttp doGet(String url, HttpClient client) {
        return doGet(url, client, HttpClientProvider.DEFAULT_MAX_CONSUMED_RESPONSE_SIZE);
    }
    ...
    public static SimpleHttp doPost(String url, HttpClient client) {
        return new SimpleHttp(url, "POST", client, HttpClientProvider.DEFAULT_MAX_CONSUMED_RESPONSE_SIZE);
    }
    ...
    public static SimpleHttp doPut(String url, HttpClient client) {
        return doPut(url, client, HttpClientProvider.DEFAULT_MAX_CONSUMED_RESPONSE_SIZE);
    }
