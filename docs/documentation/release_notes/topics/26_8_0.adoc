...
// https://github.com/keycloak/keycloak/pull/51891

The Client Secret Rotation feature is promoted from preview to supported in this release. This functionality provides a rotation policy for confidential clients that maintains up to two secrets for a transition period of time. This way, administrators can plan and anticipate the configuration of the new secrets in the applications. The feature alleviates secret leakage issues and increases the security for this type of clients.
